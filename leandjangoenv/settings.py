"""
Django settings for leandjangoenv project.
...
SECRET_KEY = 'django-insecure-96^b*8(#9p7vsf(rcl=y2^zxrp$utgl0iv$0dmi#x+hjd65l%2'
...
ROOT_URLCONF = 'leandjangoenv.urls'
...
WSGI_APPLICATION = 'leandjangoenv.wsgi.application'
